              ...
              <h1>CANTEEN FOOD SERVICE</h1>
                ...
                <div className="footer-content-center">
                    ...
                    <div className="footer-content-right">
                          ...
                          <ul>
                            <li>+91 8445518517</li>
                            <li>techmavericks@gmail.com</li>
                          </ul>
                    </div> 
            </div>
       
       <hr />
       <p className='footer-copyright'> © Copyright 2024 canteenfoodservice.com Developer Mratyunjay & Mohtashim - All Right Reserver</p>
    </div>
  )
}
